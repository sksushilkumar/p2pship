...
#define P2PSHIP_CONF_SIPP_MEDIA_PROXY_FRAGMENTATION "sip_media_proxy_fragmentation"
...
#define P2PSHIP_CONF_HIP_SHOTGUN "hip_shotgun"
#define P2PSHIP_CONF_RVS_IFACES "hip_rvs_ifaces"
#endif
